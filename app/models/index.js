...
const sequelize = new Sequelize(
  ...
  dbConfig.PASSWORD, 
  {
    ...
    dialect: dbConfig.dialect,     // Tipo de base de datos (postgres)
    pool: dbConfig.pool,           // Configuración del pool de conexiones
    port: dbConfig.PORT,           // Puerto de conexión
    dialectOptions: dbConfig.dialectOptions, // Configuración SSL para Render
